        ...
        <div className="container mx-auto px-4 py-10 max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-24 h-24 border rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                            {formData.image ? (
                                ...
                                <div
                                    className="w-full h-full flex items-center justify-center text-gray-400 text-xs">Немає
                                    фото</div>
                            )}
                        </div>
                        <label
                            className="cursor-pointer bg-blue-50 text-blue-600 px-4 py-2 rounded-lg font-bold hover:bg-blue-100 transition">
                ...
                <div className="flex items-center gap-3 py-2">
                    <input type="checkbox" id="stock" checked={formData.inStock}
                ...
                <button type="submit" disabled={isUploading}
                        className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-xl transition disabled:bg-gray-400">
