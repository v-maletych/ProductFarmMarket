...
import { products } from '../data/products'; // Імпортуємо тільки продукти
...
const Home = () => {
  return (
    <>
      {/* ===== HERO БЛОК ===== */}
      <div 
        className="relative h-[90vh] bg-cover bg-center" // Трохи зменшив висоту до 90vh
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Беремо перші 4 товари для вітрини */}
      ...
      {/* ===== СЕКЦІЯ ПЕРЕВАГ (Замість категорій - щоб не було пусто) ===== */}
