    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                <div
                    className="rounded-2xl overflow-hidden shadow-xl transform -rotate-2 hover:rotate-0 transition duration-500">
                    <img
                ...
                <div>
                    ...
                    <p className="text-gray-600 mb-4">
                        У 2020 році все почалося з маленької грядки біля дому. Ми просто хотіли годувати свою родину
                        найкращими, натуральними продуктами — без хімії, без сумнівних постачальників, без «пофіг, і так
                        з’їдять».
                        Це швидко переросло у щось більше: ми побачили, скільки фермерів працюють чесно, але не можуть
                        достукатися до покупців. І скільки людей хочуть якісні продукти, але не знають, кому довіряти.
                        Так народилася ідея створити платформу, що об’єднає тих, хто вирощує з любов’ю, і тих, хто
                        обирає усвідомлено.
                    </p>
                    <p className="text-gray-600 mb-6">
                        Сьогодні FarmMarket — це екосистема, де кожен помідор має свою історію, кожне яблуко пахне
                        справжнім садом, а не складом, а кожен покупець знає, звідки прийшов його продукт. Ми ростемо
                        разом із нашими фермерами, підтримуємо локальні господарства та робимо натуральні продукти
                        доступними для кожної родини.
                    </p>
