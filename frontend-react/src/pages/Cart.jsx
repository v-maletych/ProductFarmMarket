            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="w-full lg:w-2/3">
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        <div
                            className="hidden md:grid grid-cols-12 gap-4 p-4 bg-gray-50 border-b font-semibold text-gray-600">
                        ...
                        {cartItems.map((item) => (
                            <div key={item.id}
                                 className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center p-4 border-b last:border-b-0 hover:bg-gray-50 transition">
                                ...
                                <div
                                    className="col-span-1 md:col-span-2 text-left md:text-center font-medium text-gray-600">
                                    {item.price} грн
                                </div>
                                <div
                                    className="col-span-1 md:col-span-2 flex items-center justify-start md:justify-center gap-2">
                                    <button
                                        onClick={() => decreaseQuantity(item.id)}
                                        className="w-8 h-8 flex items-center justify-center bg-gray-200 text-gray-600 rounded-md hover:bg-gray-300 transition"
                                    >
                                        -
                                    </button>

                                    <span
                                        className="w-8 h-8 flex items-center justify-center bg-gray-100 rounded-md font-bold text-gray-700">
                    {item.quantity}
                  </span>
                                    <button
                                ...
                                <div
                                    className="col-span-1 md:col-span-2 text-left md:text-center font-bold text-green-600 text-lg">
