...
const SellerProfile = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-10">
            <div
                className="bg-white rounded-3xl shadow-lg p-8 mb-10 border border-green-100 flex flex-col md:flex-row items-center gap-8">
                <div
                    className="w-32 h-32 bg-green-100 rounded-full flex items-center justify-center text-4xl font-bold text-green-600 border-4 border-white shadow">
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-gray-600 max-w-lg">
                        Цей продавець пропонує свіжі фермерські продукти. Перегляньте асортимент нижче та підтримайте
